...
$rootPath = __DIR__."/src/scoringdance/";

$str = file_get_contents(__DIR__."/src/scoringdance/scoringdance.php");
...
file_put_contents(__DIR__."/src/scoringdance/scoringdance.php", $str);
echo("Version: ".$m2["v"]." => ".$m["v"].PHP_EOL);

// Initialize archive object
$zip = new ZipArchive();
$zip->open('dist/scoringdance.zip', ZipArchive::CREATE | ZipArchive::OVERWRITE);
...
foreach ($files as $name => $file)
{
    ...
    if (!$file->isDir())
    {
        ...
        $zip->addFile($filePath, "wordpress-scoring/".$relativePath);
    }
}
